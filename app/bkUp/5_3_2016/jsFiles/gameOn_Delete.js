...
gameOn.controller("gameOnCtrl", function($scope, $ionicPopup, mulApp1Data, multiplyFunctions){
    var TIMEOUT_MAIN = 5000;
    var TIMEOUT_PERSUM = 3000;
	$scope.mul1 = {};
	...
	$scope.newRandom = function(){
        ...
        $scope.onRetry = setTimeout($scope.retry, TIMEOUT_PERSUM, "Times up! <br/> Next?");
    ...
    $scope.retry = function(message){
		var myPopup = $ionicPopup.show({
           buttons: [
				   {
					text: '<strong>'+message+'</strong>&nbsp;&nbsp;<span class="ion-refresh"></span>',
    ...
    $scope.onloadRetry = setTimeout($scope.retry, TIMEOUT_MAIN, "Lets Start");

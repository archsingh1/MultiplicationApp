...
gameOn.controller("gameOnCtrl", function($scope, $ionicPopup, mulApp1Data){
	...
	$scope.newRandom = function(){
        ...
        //Clear the timeout set when the wrong buttons are clicked 2 times
       // clearTimeout($scope.wrongBtnClickRetry) ;
	...
	$scope.oldArray = function(oldArrval, ind){
        ...
        if($scope.count < $scope.totalCount){
            ...
            //If the answer is wrong
                ...
                $scope.wrongBtnClick ++ ;
                console.log('Wrong clicks: ' + $scope.wrongBtnClick);
   ...
   $scope.progPlay = function(){
        var progElem = document.getElementById("progClass");
        
      if(progElem.style.webkitAnimationPlayState=="running"){
        progElem.style.webkitAnimationPlayState=="paused"; console.log("running");
       }
       else if(progElem.style.webkitAnimationPlayState=="paused"){
        progElem.style.webkitAnimationPlayState=="running"; console.log("paused");
       }
